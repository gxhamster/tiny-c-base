...
////////////////////////////////////////
// NOTE(iyaan): Allocators. This is a general
// allocator interface that can be used to build other
// allocators based on this interface. Simply implement
// allocation modes given in AllocMode and the allocator
// interface will work. The default implementation in this
// file implements a simple static arena allocator but is not
// limited to it.
...
////////////////////////////////////////////
/// Public interface for allocators
...
////////////////////////////////////////////
// A Bump Allocator (Non-Growing Arena). Cannot
// do indivdual frees of allocations.
